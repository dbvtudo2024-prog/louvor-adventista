...
export function BibleProjectionScreen({ verseText, reference }: BibleProjectionProps) {
  return (
    <div className="w-full h-full bg-[#0b0d14] flex flex-col justify-between p-8 sm:p-14 md:p-18 overflow-hidden relative select-none">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[500px] bg-blue-950/10 rounded-full blur-3xl pointer-events-none" />
      ...
      {/* Bottom Right Reference in Golden Yellow (Image 1 replica) */}
      <motion.div 
      ...
      >
        <span className="text-[#facc15] font-bold text-base sm:text-xl md:text-2xl tracking-wider uppercase font-sans drop-shadow-md">
  ...
  return (
    <div className="w-full h-full bg-black flex flex-col justify-between items-center p-6 sm:p-10 md:p-14 overflow-hidden relative select-none">
      ...
      <div className="flex-1 flex items-center justify-center relative w-full my-auto">
        {/* Golden Dashed Orbit Ring */}
        <div className="w-72 h-72 sm:w-[380px] sm:h-[380px] md:w-[450px] md:h-[450px] rounded-full border-2 border-dashed border-amber-500/30 flex items-center justify-center pointer-events-none" />
        ...
        <motion.div
          ...
          className="absolute w-64 h-64 sm:w-[320px] sm:h-[320px] md:w-[380px] md:h-[380px] rounded-full bg-gradient-to-b from-[#241c12] via-[#141416] to-[#0c0c0e] border border-amber-500/50 shadow-[0_0_100px_rgba(245,158,11,0.25)] flex flex-col items-center justify-center p-6 backdrop-blur-md overflow-hidden"
        >
          {/* Subtle sparkles texture */}
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_35%,rgba(245,158,11,0.18),transparent_70%)] pointer-events-none" />
          ...
          {/* VENCEDOR! Label */}
          <span className="text-[#f59e0b] font-black text-xs sm:text-sm md:text-base tracking-[0.35em] uppercase drop-shadow-md mb-2 sm:mb-4">
            VENCEDOR!
          </span>
              ...
              return (
                <div
                  ...
                  className={`px-3 py-1.5 rounded-xl text-xs font-bold font-mono transition-all flex items-center gap-1.5 shrink-0 ${
                    isActive
                      ? 'border border-amber-400/80 bg-amber-500/15 text-amber-300 shadow-[0_0_12px_rgba(245,158,11,0.25)]'
